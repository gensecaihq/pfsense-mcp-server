...
async def delete_gateway(
    ...
    if not confirm:
        return {
            ...
            "details": f"Will permanently delete gateway {gateway_id}.",
        }
...
async def delete_gateway_group(
    ...
    if not confirm:
        return {
            "success": False,
            "error": "This is a destructive operation. Set confirm=True to proceed.",
            "details": f"Will permanently delete gateway group {group_id}.",
        }
...
async def delete_static_route(
    ...
    if not confirm:
        return {
            "success": False,
            "error": "This is a destructive operation. Set confirm=True to proceed.",
            "details": f"Will permanently delete static route {route_id}.",
        }
